...
#:
#: 价格数据已收敛到 model_registry（P2-5）：此前价格表与窗口表各自维护，
#: ``gpt-4.1`` 有窗口条目却无价格条目 → 成本恒为 0，预算闸静默失效。
#: 新增/核实模型只改 kernel/model_registry.py。
from .model_registry import PRICES_USD_PER_MTOK  # noqa: E402
