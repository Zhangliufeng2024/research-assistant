...
### Engineering Data Extraction Form
...
**Study Type:**
- [ ] Numerical simulation (FEM/CFD/DEM)
- [ ] Experimental (laboratory)
- [ ] Experimental (field)
- [ ] Analytical/semi-empirical
- [ ] Combined numerical + experimental
- [ ] Full-scale testing
- [ ] Scale model testing
...
- Software: ___ (version: ___)
- Element type: ___
- Mesh size/convergence: ___
- Material model: ___
- Boundary conditions: ___
- Loading protocol: ___
- Validation method: ___ (experimental/analytical/none)

**For Experimental Studies:**
- Specimen geometry: ___
- Material properties (with source): ___
- Test standard: ___ (ASTM/GB/EN/ISO)
- Loading protocol: ___
- Instrumentation: ___ (type, range, accuracy)
- Number of specimens: ___
- Failure mode: ___

**Key Results:**
- Ultimate capacity: ___ ± ___
- Ductility ratio: ___
- Energy dissipation: ___
- Failure mode: ___
- Safety factor achieved: ___

**Code Compliance:**
- Design code: ___ (edition: ___)
- Load combination: ___
- Material design value: ___ (clause: ___)
- Safety factor gamma_0: ___
- Compliance status: [ ] Pass [ ] Fail [ ] N/A

**Quality Assessment:**
- [ ] Mesh convergence study reported (numerical)
- [ ] Material properties verified against standard (experimental)
- [ ] Boundary conditions clearly described
- [ ] Loading protocol follows standard
- [ ] Measurement uncertainty reported
- [ ] Replicate specimens tested
- [ ] Failure mode documented with photos/schematics
- [ ] Results compared with code predictions or existing data
