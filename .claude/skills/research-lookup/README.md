...
This skill provides real-time research information lookup using Perplexity's Sonar Pro Search model through LLM API.
...
**"API key not found"**
- Ensure `LLM_API_KEY` environment variable is set
- Check that you have credits in your LLM API account

**"Model not available"**
- Verify your API key has access to Perplexity models
- Check LLM API status page for service issues

**"Rate limit exceeded"**
- Add delays between requests using `--delay` option
- Check your LLM API account limits
...
- Monitor usage through LLM API dashboard
