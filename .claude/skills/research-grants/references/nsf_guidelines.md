...
### ENG Sub-Divisions (工程学部下属学科处)

#### CMMI — Civil, Mechanical and Manufacturing Innovation (土木、机械与制造创新)
- **Focus**: Infrastructure, structures, geotechnical engineering, mechanical systems, manufacturing, design
- **Key Programs**:
  - Structural and Architectural Engineering (SAE) — structural mechanics, structural health monitoring, innovative structural systems
  - Geotechnical Engineering (GTE) — foundations, soil mechanics, geotechnical earthquake engineering
  - Engineering for Civil Infrastructure (ECI) — bridges, buildings, transportation infrastructure
  - Mechanics of Materials and Structures (MOMS) — computational mechanics, material behavior, multi-scale modeling
  - Advanced Manufacturing (AM) — additive manufacturing, smart manufacturing, digital twins
  - Dynamics, Control and Systems Diagnostics (DCSD) — system identification, control, monitoring
- **Keywords**: structural engineering, geotechnical, earthquake engineering, construction, infrastructure, mechanics, manufacturing, smart structures, digital twin
- **Budget Range**: Standard: $300K-$500K/3yr; CAREER: $400K-$600K/5yr
- **Cross-disciplinary**: AI for infrastructure, ML for structural health monitoring, smart cities

#### CBET — Chemical, Bioengineering, Environmental, and Transport Systems (化学、生物工程、环境与传输系统)
- **Focus**: Environmental engineering, chemical processes, bioengineering, transport phenomena
- **Key Programs**:
  - Environmental Engineering (EnvE) — water treatment, air quality, remediation, sustainability
  - Environmental Sustainability (EnvS) — sustainable systems, life cycle assessment, industrial ecology
  - Process Systems, Reaction Engineering, and Molecular Thermodynamics (PRT) — chemical engineering
  - Bioengineering (BIO) — biomedical engineering, biosensors
  - Transport and Thermal Fluids (TTF) — fluid mechanics, heat transfer
- **Keywords**: environmental engineering, water treatment, air pollution, remediation, sustainability, LCA, carbon footprint, energy systems, climate
- **Budget Range**: Standard: $300K-$500K/3yr; CAREER: $400K-$600K/5yr
- **Cross-disciplinary**: AI for environmental monitoring, ML for water quality prediction, smart energy systems

#### ECCS — Electrical, Communications and Cyber Systems (电气、通信与网络系统)
- **Focus**: Electronics, communications, power systems, cybersecurity
- **Keywords**: IoT, sensors, wireless, power grid, smart grid, signal processing, cybersecurity

#### EEC — Engineering Education and Centers (工程教育与中心)
- **Focus**: Engineering education research, I/UCRC (Industry-University Cooperative Research Centers), ERC (Engineering Research Centers)
- **Keywords**: engineering education, broadening participation, workforce development

#### EEI — Energy, Equity, and Innovation (能源、公平与创新)
- **Focus**: Energy systems, energy equity, clean energy transitions
- **Keywords**: renewable energy, energy storage, energy justice, clean energy policy

### NSF ENG Proposal Strategy
- **CMMI** is the primary target for civil/structural engineering proposals
- **CBET** is the primary target for environmental engineering proposals
- When proposing AI+Engineering cross-disciplinary research, target CMMI or CBET (not CISE) — the engineering application must be central
- CISE funds CS-theory-centric proposals; ENG funds application-centric proposals using CS methods
- For joint proposals, use "Collaborative Research" mechanism across CMMI/CBET + CISE
