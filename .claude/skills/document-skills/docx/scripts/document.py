...
class DocxXMLEditor(XMLEditor):
    ...
    def __init__(
        self, xml_path, rsid: str, author: str = "Research-Assistant", initials: str = "SW"
    ):
        ...
        Args:
            ...
            author: Author name for tracked changes and comments (default: "Research-Assistant")
...
class Document:
    ...
    def __init__(
        ...
        Args:
            ...
            author: Default author name for comments (default: "Research-Assistant")
