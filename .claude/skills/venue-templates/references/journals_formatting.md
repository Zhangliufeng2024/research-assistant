...
| **ASCE Journals** | 10,000 words | Single col (sub) | (Author year) | `asce_journal.tex` |
| **Elsevier Engineering** | Varies (~8,000) | Single col (sub) | [1] Numbered | `elsevier_engineering.tex` |
| **Applied Energy** | ~8,000 words | Single col (sub) | [1] Numbered | `elsevier_engineering.tex` |
| **Engineering Structures** | ~8,000 words | Single col (sub) | [1] Numbered | `elsevier_engineering.tex` |
| **J. Clean. Prod.** | ~8,000 words | Single col (sub) | [1] Numbered | `elsevier_engineering.tex` |
