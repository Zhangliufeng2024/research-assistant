...
## Civil & Structural Engineering Conferences

### ASCE Structures Congress

**Conference Type**: Annual ASCE structural engineering conference
**Frequency**: Annual (spring)

**Formatting Requirements**:
- **Page Limit**: 10 pages maximum (including references and figures)
- **Format**: Single column, double-spaced for submission; published as camera-ready
- **Font**: Times New Roman 12pt
- **Margins**: 1 inch all sides
- **Citations**: ASCE author-year style: (Smith and Jones 2021)
- **Abstract**: ≤300 words, submitted separately during proposal stage
- **Figures**: 300 dpi minimum, embedded in document
- **Template**: ASCE conference paper template (available on ASCE website)

**Content Notes**:
- Papers present preliminary or recently completed research
- More permissive than ASCE journals — developing work acceptable
- Proceedings published in ASCE Library

**Website**: https://www.structurescongress.org/

---

### ICOSSAR (International Conference on Structural Safety and Reliability)

**Conference Type**: Flagship international structural reliability conference
**Frequency**: Every 4 years

**Formatting Requirements**:
- **Page Limit**: 8 pages
- **Format**: Two-column (CRC Press proceedings format)
- **Font**: Times New Roman 10pt
- **Citations**: Numbered [1], [2] (proceedings style)
- **Abstract**: ≤200 words in submission system

**Website**: https://www.icossar.org/

---

### WCEE (World Conference on Earthquake Engineering)

**Conference Type**: Premier international earthquake engineering conference
**Frequency**: Every 4 years

**Formatting Requirements**:
- **Page Limit**: 10 pages
- **Format**: Two-column proceedings format
- **Font**: Times New Roman 10pt
- **Citations**: Numbered sequential
- **Abstract**: ≤200 words
- **Topics**: Structural response, ground motion, seismic design codes, performance-based engineering

**Website**: https://www.wcee.nicee.org/

---

### COMPDYN (Computational Methods in Structural Dynamics and Earthquake Engineering)

**Conference Type**: European computational earthquake engineering conference
**Frequency**: Every 2 years (odd years)

**Formatting Requirements**:
- **Page Limit**: 10–20 pages (extended abstract or full paper)
- **Format**: Single column
- **Font**: Times New Roman 11pt
- **Citations**: Numbered [1]
- **LaTeX**: Standard article class

---

### fib Symposium (International Federation for Structural Concrete)

**Conference Type**: International concrete structures symposium
**Frequency**: Annual

**Formatting Requirements**:
- **Page Limit**: 8 pages
- **Format**: Two-column
- **Topics**: Concrete design, prestressed structures, durability, sustainability

---

### ICSHM (International Conference on Structural Health Monitoring)

**Conference Type**: Premier SHM conference
**Frequency**: Every 2 years

**Formatting Requirements**:
- **Page Limit**: 8–10 pages
- **Format**: Two-column proceedings
- **Topics**: Sensor systems, signal processing, damage detection, ML for SHM, digital twins

---

## Energy & Environmental Engineering Conferences

### IBPSA Building Simulation

**Conference Type**: International Building Performance Simulation Association conference
**Frequency**: Annual (BS) and biennial (BSA)

**Formatting Requirements**:
- **Page Limit**: 8 pages
- **Format**: Two-column (IBPSA proceedings template)
- **Font**: Times New Roman 10pt
- **Citations**: Numbered [1]
- **Abstract**: ≤200 words
- **Topics**: EnergyPlus, OpenStudio, IDA-ICE simulations; building energy performance; HVAC optimization; thermal comfort; net-zero buildings

**Website**: https://www.ibpsa.org/

---

### eceee Summer Study (European Council for an Energy-Efficient Economy)

**Conference Type**: European energy efficiency policy and technology conference
**Frequency**: Biennial (odd years)

**Formatting Requirements**:
- **Page Limit**: 10 pages (full paper) or 2 pages (extended abstract)
- **Format**: Single column
- **Topics**: Energy policy, demand-side management, building renovation, decarbonization pathways

**Website**: https://www.eceee.org/summerstudy/

---

### SBE (Sustainable Built Environment) Conferences

**Conference Type**: International sustainable buildings series
**Frequency**: Regional conferences annually

**Formatting Requirements**:
- **Page Limit**: 6–8 pages
- **Format**: IOP Conference Series template (two-column)
- **Citations**: Numbered [1]
- **Topics**: LCA, embodied carbon, net-zero buildings, circular economy in construction

---

### IEEE PES General Meeting

**Conference Type**: IEEE Power and Energy Society annual meeting
**Frequency**: Annual

**Formatting Requirements**:
- **Page Limit**: 6 pages (standard), 8 pages (extended)
- **Format**: Two-column IEEE format (`IEEEtran` class)
- **Font**: Times New Roman 10pt
- **Citations**: IEEE numbered [1]
- **Anonymization**: NOT required (single-blind)
- **Topics**: Smart grid, renewable integration, power systems stability, energy storage, demand response
...
**Conference Type**: Premier solar PV conference
**Frequency**: Annual

**Formatting Requirements**:
- **Page Limit**: 4 pages
- **Format**: Two-column IEEE format
- **Topics**: Solar cell efficiency, PV systems, agrivoltaics, LCOE analysis

---

### ASHRAE Annual Conference

**Conference Type**: American Society of Heating, Refrigerating and Air-Conditioning Engineers
**Frequency**: Annual (summer and winter)

**Formatting Requirements**:
- **Page Limit**: 10–12 pages
- **Format**: ASHRAE transactions format (single column)
- **Citations**: Numbered
- **Topics**: HVAC design, building energy, thermal comfort, indoor air quality, net-zero

**Website**: https://www.ashrae.org/conferences

---

## Quick Reference: Engineering Conferences

| Conference | Field | Frequency | Pages | Citation Style | Blind? |
|------------|-------|-----------|-------|---------------|--------|
| ASCE Structures Congress | Civil/Structural | Annual | 10 | Author-year | No |
| ICOSSAR | Structural Reliability | 4yr | 8 | Numbered | No |
| WCEE | Earthquake Eng. | 4yr | 10 | Numbered | No |
| COMPDYN | Computational | 2yr | 10–20 | Numbered | No |
| fib Symposium | Concrete | Annual | 8 | Numbered | No |
| ICSHM | SHM | 2yr | 8–10 | Numbered | No |
| IBPSA Building Simulation | Building Energy | Annual/Biennial | 8 | Numbered | No |
| eceee Summer Study | Energy Policy | 2yr | 10 | — | No |
| IEEE PES General Meeting | Power Systems | Annual | 6–8 | IEEE [n] | No |
| IEEE PVSC | Solar PV | Annual | 4 | IEEE [n] | No |
| ASHRAE Annual | HVAC/Buildings | Annual | 10–12 | Numbered | No |
