...
All infographic visuals MUST follow the **Unified Visual Style Guide** at `figure-generation/references/unified_visual_style.md`. Before generating any infographic, read that file and include its "AI-Generated Diagrams" directives in your prompt to ensure visual consistency with all other figures in the project.
...
- Include unified style directives from `figure-generation/references/unified_visual_style.md` in every prompt (see **Style Reference** below)
...
4. **Decision**: If quality >= threshold 閳?**DONE** (no more iterations needed!)
...
- 閴?Saves API calls if first generation is good enough
- 閴?Higher quality standards for marketing materials
- 閴?Faster turnaround for drafts/internal use
- 閴?Appropriate quality for each use case
...
```
閳瑰备鏀㈤埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞?
閳? 1. Generate infographic with Nano Banana Pro       閳?
閳?                   閳?                               閳?
閳? 2. Review quality with Gemini 3 Pro                閳?
閳?                   閳?                               閳?
閳? 3. Score >= threshold?                             閳?
閳?      YES 閳?DONE! (early stop)                      閳?
閳?      NO  閳?Improve prompt, go to step 1            閳?
閳?                   閳?                               閳?
閳? 4. Repeat until quality met OR max iterations      閳?
閳规柡鏀㈤埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞鈧埞?
```
