...
if [ -z "$LLM_API_KEY" ]; then
    echo "鉂?Error: LLM_API_KEY environment variable not set"
    echo ""
    echo "Get an API key at: https://openrouter.ai/keys"
    echo "Then set it with: export LLM_API_KEY='your_key'"
    exit 1
fi

echo "鉁?LLM_API_KEY is set"
echo ""

# Create output directory
mkdir -p figures
echo "鉁?Created figures/ directory"
echo ""
...
echo ""
echo "鉁?Generated: figures/consort_example.png"
...
echo ""
echo "鉁?Generated: figures/neural_net_example.png"
echo ""
...
echo "---------------------------"
python scripts/generate_schematic.py \
  "Simple signaling pathway: Receptor 鈫?Kinase A 鈫?Kinase B 鈫?Transcription Factor 鈫?Gene. Show arrows with 'activation' labels. Use different colors for each component." \
  -o figures/pathway_example.png \
  --iterations 2

echo ""
echo "鉁?Generated: figures/pathway_example.png"
echo ""
