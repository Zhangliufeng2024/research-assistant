...
闁宠澹曢弨銏ゅ煘閳?setup.py
闁宠澹曢弨銏ゅ煘閳?my_plugin/
闁?  闁宠澹曢弨銏ゅ煘閳?__init__.py
闁?  闁宠鏌￠弨銏ゅ煘閳?converter.py
...
### using LLM API for Image Descriptions

```python
from markitdown import MarkItDown
from openai import OpenAI

# Initialize LLM API client (OpenAI-compatible API)
client = OpenAI(
...
|----------|-------------|---------|
| `LLM_API_KEY` | LLM API key for image descriptions | `sk-or-v1-...` |
