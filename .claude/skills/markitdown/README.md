...
Use AI models via LLM API to generate detailed image descriptions:

```python
from openai import OpenAI

# LLM API provides access to 100+ AI models
client = OpenAI(
...
```bash
# Convert with AI descriptions via LLM API
...
This skill integrates seamlessly with the Research Assistant CLI for:
...
- LLM API key (for AI-enhanced conversions) - Get at https://openrouter.ai/keys
