...
For AI-powered image descriptions using LLM API:

### LLM API

LLM API provides unified access to multiple AI models (GPT-4, Claude, Gemini, etc.) through a single API.
...
cd /Users/vinayak/Documents/research-assistant/.claude/skills/markitdown/scripts
...
def test_basic():
    ...
    print("闁?Basic conversion works")
