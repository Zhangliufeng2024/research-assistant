...
python {work_dir}/.claude/skills/scientific-schematics/scripts/generate_schematic.py \
...
python {work_dir}/.claude/skills/generate-image/scripts/generate_image.py \
...
python {work_dir}/.claude/skills/research-lookup/scripts/research_lookup.py \
