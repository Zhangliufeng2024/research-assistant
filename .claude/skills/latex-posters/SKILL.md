...
All poster visuals MUST follow the **Unified Visual Style Guide** at `figure-generation/references/unified_visual_style.md`. Before generating any figure or diagram for a poster, read that file and include its "AI-Generated Diagrams" directives in your prompt to ensure visual consistency with all other figures in the project.
