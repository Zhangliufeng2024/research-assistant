...
**Option 2: LLM API** (alternative to OpenAI)
```
...
- Claude models via LLM API
- Other LLM API-supported models
...
```
Paper2All/
閳规壕鏀㈤埞鈧?.env                  # API credentials
閳规壕鏀㈤埞鈧?input/               # Place your paper files here
閳?  閳规柡鏀㈤埞鈧?paper_name/      # Each paper in its own directory
閳?      閳规柡鏀㈤埞鈧?main.tex     # LaTeX source or PDF
閳规壕鏀㈤埞鈧?output/              # Generated outputs
閳?  閳规柡鏀㈤埞鈧?paper_name/
閳?      閳规壕鏀㈤埞鈧?website/     # Generated website files
閳?      閳规壕鏀㈤埞鈧?video/       # Generated video files
閳?      閳规柡鏀㈤埞鈧?poster/      # Generated poster files
閳规柡鏀㈤埞鈧?...
```
