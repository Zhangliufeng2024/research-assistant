---
name: pptx-posters
description: "Create professional research posters in HTML/PPTX format using web technologies. Support for conference presentations, academic posters, and scientific communication with responsive layouts, figure integration, and poster-specific best practices for visual communication."
allowed-tools: [Read, Write, Edit, Bash]
---

# HTML/PPTX Research Posters

## Overview

Research posters are a critical medium for scientific communication at conferences, symposia, and academic events. This skill provides comprehensive guidance for creating professional, visually appealing research posters using HTML/CSS or python-pptx. Generate publication-quality posters with responsive layouts, proper typography, color schemes, and visual hierarchy.
