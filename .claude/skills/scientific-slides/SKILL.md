...
**Unified Style**: All slide visuals MUST follow the **Unified Visual Style Guide** at `figure-generation/references/unified_visual_style.md`. Before generating any figure or diagram for slides, read that file and include its "AI-Generated Diagrams" directives in your prompt to maintain visual consistency with other figures in the same research project.
...
Diagram slide:
"Presentation slide showing the research methodology. Title: 'Study Design'. Flowchart showing: Patient Screening 閳?Randomization 閳?Treatment Groups (A, B, Control) 閳?Follow-up 閳?Analysis. CONSORT-style flow diagram. Professional academic style."
```
...
閴?**What Makes Presentations Dry and Forgettable:**
...
閴?**What Makes Presentations Engaging and Memorable:**
...
- Structure: Brief intro 閳?minimal methods 閳?key results 閳?quick conclusion
...
- Structure: Problem 閳?significance 閳?approach 閳?feasibility 閳?impact
...
- Structure: Context 閳?methods 閳?results 閳?critical analysis
...
- All text readable (閳?8pt equivalent)
- Adequate contrast (閳?.5:1)
...
- [ ] One main idea per slide
- [ ] Font sizes 閳?8pt (preferably 24pt+)
...
- 4-6 words per bullet (shorter than 6鑴? rule)
- Key terms in bold
...
1. **Research & Plan** (45 minutes):
   ...
   - Outline content (intro 閳?methods 閳?2-3 key results 閳?conclusion)
