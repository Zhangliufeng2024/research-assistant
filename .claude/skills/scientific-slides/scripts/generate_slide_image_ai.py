...
Generate a high-quality {'visual/figure' if visual_only else 'presentation slide'} that meets all the guidelines above."""
        ...
        for i in range(1, iterations + 1):
            ...
            if not needs_improvement:
                print(f"\n鉁?Quality meets threshold ({score} >= {self.QUALITY_THRESHOLD})")
            ...
            print(f"\n鈿?Quality below threshold ({score} < {self.QUALITY_THRESHOLD})")
