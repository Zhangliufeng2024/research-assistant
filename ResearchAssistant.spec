...
datas = [('D:\\vscode files\\research-assistant-v3\\research_assistant\\web\\static', 'research_assistant/web/static'), ('C:\\Users\\ZHANGL~1\\AppData\\Local\\Temp\\ra_claude_clean_ufk3s0qg', '.claude')]
binaries = []
